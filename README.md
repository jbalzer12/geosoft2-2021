# Geosoftware II handout repository (WiSe 2021/22)
...
[LSF/QISPOS](https://studium.uni-muenster.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=347180&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung)

[Learnweb course](https://www.uni-muenster.de/LearnWeb/learnweb2/course/view.php?id=55119)
...
**Due date**: October 13th, 2021, 14:00 hrs CET.
...
The goal of the project in this semester is to develop a web-based machine learning toolkit for land cover classifications based on Satellite imagery, which produces not only the prediction maps but also computes the [Area of Applicability](https://arxiv.org/abs/2005.07939). Your task will not be the development of the methods, but their implementation as a web-based toolkit. Detailed information about the goals and deliverables will be communicated along with the invitation for bid at the start of the semester. 
